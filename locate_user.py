...
def locate_ble():
    ...
    signal, signal_no_filter, positions_list=loop_signal(iterations=n_measurement, list_beacons=[ble1,ble2,ble3], last_values=init_loop(list_beacons=[ble1,ble2,ble3]), current_position=False)
