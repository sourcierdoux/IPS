...
def locate_ble(shared_data,plot=False,n_measurement=20,current_position=False):
    ...
    ble1 = beacon(x=1.2*0.6,y=15.5*0.6,address="2DAF08FB-4088-5671-EF24-0D22646F1333",name="BLE_beacon_3",power_ref=-51)
    ble2= beacon(x=1.2*0.6,y=1.2*0.6,address="47F437F8-0807-D40D-CDD7-1098351C398C", name="BLE_beacon_1",power_ref=-49)
    ble3= beacon(x=11*0.6, y=9.1*0.6, address="76F34488-4ECB-C658-B1F4-56C1AC9D741F", name="BLE_beacon_2",power_ref=-47)
